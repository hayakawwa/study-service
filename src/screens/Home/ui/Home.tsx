...
const Home: FC = () => {
	...
	return (
		<Layout>
			...
			{dataIsEmpty && <div className={cls.emptyMessage}>Пока что тут пусто... Создайте первую заявку!</div>}
			{!dataIsEmpty &&
			<div className={cls.table}>
				...
				{table.getRowModel().rows.map((row) => (
						<div className={cls.tr} key={row.id} onClick={() => navigation(`${Path.applications}/${row.original.id}`)}>
